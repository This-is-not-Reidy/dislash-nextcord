...
class ClickListener:
    ...
    or call :class:`nextcord.Message.create_click_listener(timeout)`
    ...
    def from_user(self, user: nextcord.User, *, cancel_others: bool = False, reset_timeout: bool = True):
        """
        A decorator that makes the function below waiting for a click
    ...
    def not_from_user(self, user: nextcord.User, *, cancel_others: bool = False, reset_timeout: bool = True):
        """
        A decorator that makes the function below waiting for a click
