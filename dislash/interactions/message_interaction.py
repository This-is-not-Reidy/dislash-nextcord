...
class MessageInteraction(BaseInteraction):
    ...
    Obtainable via :class:`nextcord.Context.wait_for_button_click`
    ...
    guild : :class:`nextcord.Guild` | ``None``
    ...
    def __init__(self, client, data):
        ...
        if msg_data is None:
            ...
            # channel must not be None, because channel.id attr is needed in nextcord.Message.__init__
